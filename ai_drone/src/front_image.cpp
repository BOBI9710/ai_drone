...
void imageCallback(const sensor_msgs::ImageConstPtr& msg)
{
  ...
  try
  {
    ...
    //show roi area
    rectangle(img_houghC, Rect(30, 0, 100, 110), Scalar(0, 0, 0), 1, 8, 0);
    rectangle(img_houghC, Rect(190, 0, 100, 110), Scalar(0, 0, 0), 1, 8, 0);

    //roi
    Mat img_roi_1, img_roi_2, mask_img;
    canny_img.copyTo(mask_img);
   
    img_roi_1 = mask_img(Rect(30, 0, 100, 110));
    img_roi_2 = mask_img(Rect(190, 0, 100, 110));
    ...
    HoughLines(img_roi_2, lines_2, 1, CV_PI / 180, 100);
     ...
     // mode
      if(a == 1){
        ...
        if(lines_1.size() > 0){
           rectangle(img_houghC, Rect(30, 0, 100, 110), Scalar(0, 0, 255), 2.5, 8, 0);
          }
        ...
        if(lines_2.size() > 0){
           rectangle(img_houghC, Rect(190, 0, 100, 110), Scalar(0, 0, 255), 2.5, 8, 0);
          }      
      ...
      if(mode == 4){
       rectangle(img_houghC, Rect(30, 0, 100, 110), Scalar(255, 0, 0), 2.5, 8, 0);
       rectangle(img_houghC, Rect(190, 0, 100, 110), Scalar(255, 0, 0), 2.5, 8, 0);
