...
void imageCallback(const sensor_msgs::ImageConstPtr& msg)
{
  ...
  try
  {
    ...
    //show roi area
    rectangle(img_houghC, Rect(30, 0, 130, 120), Scalar(0, 0, 0), 1, 8, 0);
    rectangle(img_houghC, Rect(160, 0, 130, 120), Scalar(0, 0, 0), 1, 8, 0);
    ...
    HoughLines(img_roi_2, lines_2, 1, CV_PI / 180, 90);
     ...
     // mode
      if(a == 1){
        ...
        if(lines_1.size() > 0){
           rectangle(img_houghC, Rect(30, 0, 130, 120), Scalar(0, 0, 255), 2.5, 8, 0);
          }
        ...
        if(lines_2.size() > 0){
           rectangle(img_houghC, Rect(160, 0, 130, 120), Scalar(0, 0, 255), 2.5, 8, 0);
          }      
      ...
      if(mode == 4){
       rectangle(img_houghC, Rect(30, 0, 130, 120), Scalar(255, 0, 0), 2.5, 8, 0);
       rectangle(img_houghC, Rect(160, 0, 130, 120), Scalar(255, 0, 0), 2.5, 8, 0);
